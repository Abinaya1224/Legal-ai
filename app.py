...
pytesseract.pytesseract.tesseract_cmd = r'C:/Users/Abinaya/AppData/Local/Programs/Tesseract-OCR/tesseract.exe'
...
def upload_file():
    ...
    summary_input = f"Summarize this: {extracted_text}"
    summary_response = model.generate_content(summary_input)
    summary_text = summary_response.text if summary_response.text else "No summary generated."
    responses['summary.txt'] = add_bullet_points(summary_text)  
    ...
    responses['key_informations.txt'] = key_info_text 
